...
/// <param name="liveStreamUpdatePayload"> (optional)</param>
		...
		public ApiResponse<LiveStream> updateWithHttpInfo(string liveStreamId, LiveStreamUpdatePayload liveStreamUpdatePayload = default)
        {
            if (liveStreamUpdatePayload == null) 
                throw new ApiException(400,"Missing required parameter 'liveStreamUpdatePayload' when calling LiveApi->update");
		...
		public ApiResponse<LiveStream> createWithHttpInfo(LiveStreamCreatePayload liveStreamCreatePayload = default)
        {
            if (liveStreamCreatePayload == null) 
                throw new ApiException(400,"Missing required parameter 'liveStreamCreatePayload' when calling LiveApi->create");
            
            if (liveStreamCreatePayload != null && liveStreamCreatePayload.name == null) {
                throw new ApiException(400,"Missing required parameter 'liveStreamCreatePayload.Name' when calling LiveApi->create");
            }
