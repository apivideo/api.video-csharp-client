# VideoApiClient.Api.LiveApi

All URIs are relative to *https://ws.api.video*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete**](LiveApi.md#deletelivestreamslivestreamid) | **DELETE** /live-streams/{liveStreamId} | Delete a live stream
[**deleteThumbnail**](LiveApi.md#deletelivestreamslivestreamidthumbnail) | **DELETE** /live-streams/{liveStreamId}/thumbnail | Delete a thumbnail
[**list**](LiveApi.md#getlivestreams) | **GET** /live-streams | List all live streams
[**get**](LiveApi.md#getlivestreamslivestreamid) | **GET** /live-streams/{liveStreamId} | Show live stream
[**update**](LiveApi.md#patchlivestreamslivestreamid) | **PATCH** /live-streams/{liveStreamId} | Update a live stream
[**create**](LiveApi.md#postlivestreams) | **POST** /live-streams | Create live stream
[**uploadThumbnail**](LiveApi.md#postlivestreamslivestreamidthumbnail) | **POST** /live-streams/{liveStreamId}/thumbnail | Upload a thumbnail
...
namespace Example
{
    public class deleteExample
    {
        public static void Main()
        {
            ...
            var apiLiveInstance = apiInstance.Live();
            try
            {
                // Delete a live stream
                apiLiveInstance.delete(liveStreamId);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.delete: " + e.Message );
...
namespace Example
{
    public class deleteThumbnailExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a thumbnail
                LiveStream result = apiLiveInstance.deleteThumbnail(liveStreamId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.deleteThumbnail: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class listExample
    {
        public static void Main()
        {
            ...
            {
                // List all live streams
                LiveStreamListResponse result = apiLiveInstance.list(streamKey, name, sortBy, sortOrder, currentPage, pageSize);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.list: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class getExample
    {
        public static void Main()
        {
            ...
            {
                // Show live stream
                LiveStream result = apiLiveInstance.get(liveStreamId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.get: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **update**
> LiveStream update (string liveStreamId, LiveStreamUpdatePayload liveStreamUpdatePayload = null)
...
namespace Example
{
    public class updateExample
    {
        public static void Main()
        {
            ...
            var liveStreamUpdatePayload = new LiveStreamUpdatePayload(); // LiveStreamUpdatePayload |  (optional) 
            var apiLiveInstance = apiInstance.Live();
            try
            {
                // Update a live stream
                LiveStream result = apiLiveInstance.update(liveStreamId, liveStreamUpdatePayload);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.update: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **create**
> LiveStream create (LiveStreamCreatePayload liveStreamCreatePayload = null)
...
namespace Example
{
    public class createExample
    {
        public static void Main()
        {
            ...
            var liveStreamCreatePayload = new LiveStreamCreatePayload(); // LiveStreamCreatePayload |  (optional) 
            var apiLiveInstance = apiInstance.Live();
            try
            {
                // Create live stream
                LiveStream result = apiLiveInstance.create(liveStreamCreatePayload);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.create: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class uploadThumbnailExample
    {
        public static void Main()
        {
            ...
            {
                // Upload a thumbnail
                LiveStream result = apiLiveInstance.uploadThumbnail(liveStreamId, file);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling LiveApi.uploadThumbnail: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
