...
/// <param name="file">The video text track (VTT) you want to upload.</param>
		...
		public Task<Caption> uploadAsync(string videoId, string language, System.IO.Stream file, CancellationToken cancellationToken = default)
        {
             Task<ApiResponse<Caption>> localVarResponse = uploadWithHttpInfoAsync(videoId, language, file, cancellationToken);
             return localVarResponse.ContinueWith((Task<ApiResponse<Caption>> task) => task.Result.Data );
...
/// <param name="file">The video text track (VTT) you want to upload.</param>
		...
		public Task<ApiResponse<Caption>> uploadWithHttpInfoAsync(string videoId, string language, System.IO.Stream file, CancellationToken cancellationToken = default)
        {
...
/// <param name="language">A valid language identifier using IETF language tags. You can use primary subtags like &#x60;en&#x60; (English), extended subtags like &#x60;fr-CA&#x60; (French, Canada), or region subtags like &#x60;zh-Hans-CN&#x60; (Simplified Chinese used in the PRC).  - This parameter **only accepts dashes for separators**, for example &#x60;fr-CA&#x60;. If you use a different separator in your request, the API returns an error. - When the value in your request does not match any covered language, the API returns an error. - You can find the list of supported tags [here](https://docs.api.video/vod/add-captions#supported-caption-language-tags).</param>
        ...
        /// <returns>Caption</returns>
		public Task<Caption> getAsync(string videoId, string language, CancellationToken cancellationToken = default)
        {
             Task<ApiResponse<Caption>> localVarResponse = getWithHttpInfoAsync(videoId, language, cancellationToken);
             return localVarResponse.ContinueWith((Task<ApiResponse<Caption>> task) => task.Result.Data );
...
/// <param name="language">A valid language identifier using IETF language tags. You can use primary subtags like &#x60;en&#x60; (English), extended subtags like &#x60;fr-CA&#x60; (French, Canada), or region subtags like &#x60;zh-Hans-CN&#x60; (Simplified Chinese used in the PRC).  - This parameter **only accepts dashes for separators**, for example &#x60;fr-CA&#x60;. If you use a different separator in your request, the API returns an error. - When the value in your request does not match any covered language, the API returns an error. - You can find the list of supported tags [here](https://docs.api.video/vod/add-captions#supported-caption-language-tags).</param>
        ...
        /// <returns>ApiResponse of Caption</returns>
		public Task<ApiResponse<Caption>> getWithHttpInfoAsync(string videoId, string language, CancellationToken cancellationToken = default)
        {
...
/// <param name="captionsUpdatePayload"></param>
        ...
        /// <returns>Caption</returns>
		public Task<Caption> updateAsync(string videoId, string language, CaptionsUpdatePayload captionsUpdatePayload, CancellationToken cancellationToken = default)
        {
             Task<ApiResponse<Caption>> localVarResponse = updateWithHttpInfoAsync(videoId, language, captionsUpdatePayload, cancellationToken);
             return localVarResponse.ContinueWith((Task<ApiResponse<Caption>> task) => task.Result.Data );
...
/// <param name="captionsUpdatePayload"></param>
        ...
        /// <returns>ApiResponse of Caption</returns>
		public Task<ApiResponse<Caption>> updateWithHttpInfoAsync(string videoId, string language, CaptionsUpdatePayload captionsUpdatePayload, CancellationToken cancellationToken = default)
        {
...
/// <param name="pageSize">Results per page. Allowed values 1-100, default is 25. (optional, default to 25)</param>
		...
		public Task<CaptionsListResponse> listAsync(string videoId, int? currentPage = default, int? pageSize = default, CancellationToken cancellationToken = default)
        {
             Task<ApiResponse<CaptionsListResponse>> localVarResponse = listWithHttpInfoAsync(videoId, currentPage, pageSize, cancellationToken);
             return localVarResponse.ContinueWith((Task<ApiResponse<CaptionsListResponse>> task) => task.Result.Data );
...
/// <param name="pageSize">Results per page. Allowed values 1-100, default is 25. (optional, default to 25)</param>
		...
		public Task<ApiResponse<CaptionsListResponse>> listWithHttpInfoAsync(string videoId, int? currentPage = default, int? pageSize = default, CancellationToken cancellationToken = default)
        {
            ...
            return localVarResponse.ContinueWith((Task<RestResponse> task) =>
            {
                ...
                return new ApiResponse<CaptionsListResponse>(localVarStatusCode,
                    task.Result.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                    (CaptionsListResponse) this.ApiClient.Deserialize(task.Result, typeof(CaptionsListResponse)));
            });
