...
namespace VideoApiClient.Api
{
    ...
    public class PlayersApi
    {
        ...
        {
             ApiResponse<Object> localVarResponse = deleteLogoWithHttpInfo(playerId);
...
/// <param name="playerUpdatePayload"></param>
		...
		public ApiResponse<Player> updateWithHttpInfo(string playerId, PlayerUpdatePayload playerUpdatePayload)
        {
            ...
            // verify the required parameter 'playerId' is set
            if (playerId == null)
                throw new ApiException(400, "Missing required parameter 'playerId' when calling PlayersApi->update");
...
/// <param name="link">The path to the file you want to upload and use as a logo.</param>
		...
		public ApiResponse<Player> uploadLogoWithHttpInfo(string playerId, System.IO.Stream file, string link)
        {
            ...
            // verify the required parameter 'playerId' is set
            if (playerId == null)
                throw new ApiException(400, "Missing required parameter 'playerId' when calling PlayersApi->uploadLogo");
            // verify the required parameter 'file' is set
            if (file == null)
                throw new ApiException(400, "Missing required parameter 'file' when calling PlayersApi->uploadLogo");
